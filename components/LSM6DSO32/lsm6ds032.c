...
void lsm6dso32_config(i2c_master_dev_handle_t lsm6dso32_handle) {
    ...
    Sets config for LSM6DSO32
        ...
        - Accel ODR 416 Hz, FS 32 g, LPF2 off
        - BDU on, IF_INC on
        - Timestamp enabled
    */
    uint8_t ctrl1_xl[2] = {IMU_CTRL1_XL,
        IMU_CTRL1_LPF2_XL_EN_OFF | IMU_CTRL1_FS_XL_32g | IMU_CTRL1_ODR_XL_416Hz
    };
    uint8_t ctrl2_g[2] = {IMU_CTRL2_G,
        IMU_CTRL2_FS_125_OFF | IMU_CTRL2_FS_G_2000dps | IMU_CTRL2_ODR_G_416Hz
    };
